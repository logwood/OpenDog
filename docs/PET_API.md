...
& $Python tools\smoke_test_pet_api.py `
  ...
  --output ..\..\artifacts\evaluations\pet_api_semantic_v3_cuda_smoke.json
```
...
were available, both fusion weights were positive, and Top-1 was correct:
    ...
    & $Python tools\smoke_test_pet_api.py `
      --enroll "pet-a=..\..\data\raw\DogFaceNet_alignment\images\180&tit=Wolf.00854.jpg" `
      --enroll "pet-a=..\..\data\raw\DogFaceNet_alignment\images\180&tit=Wolf.00855.jpg" `
      --enroll "pet-b=..\..\data\raw\DogFaceNet_alignment\images\231&tit=Dorl.01084.jpg" `
      --enroll "pet-b=..\..\data\raw\DogFaceNet_alignment\images\231&tit=Dorl.01086.jpg" `
      --query "..\..\data\raw\DogFaceNet_alignment\images\180&tit=Wolf.01229.jpg" `
      --expected-pet-id pet-a `
      --require-query-dual-branch `
      --output ..\..\artifacts\evaluations\pet_api_semantic_v3_dual_branch_smoke.json
