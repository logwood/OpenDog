...
class AMPTrainer(SimpleTrainer):
    ...
    def __init__(self, model, data_loader, optimizer, param_wrapper, grad_scaler=None):
        ...
        # Ada/Ampere-class GPUs can use BF16's much wider exponent range.  It
        # avoids CircleLoss gradient overflow while keeping mixed-precision
        # tensor-core execution. Older CUDA GPUs fall back to FP16 scaling.
        self.amp_dtype = (
