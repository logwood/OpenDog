...
@META_ARCH_REGISTRY.register()
class LatentWorkspaceV2Baseline(LatentWorkspaceBaseline):
    ...
    def __init__(
        ...
        *,
        ...
        """Experimental configurable constructor for the V2 latent workspace."""
        super().__init__(
            backbone=backbone,
            heads=heads,
            workspace=workspace,
...
@META_ARCH_REGISTRY.register()
class LatentWorkspaceV3Baseline(LatentWorkspaceBaseline):
    ...
    def __init__(
        ...
        *,
        ...
        """Experimental configurable constructor for the V3 latent workspace."""
        super().__init__(
            backbone=backbone,
            heads=heads,
            workspace=workspace,
