...
def create_app(
    ...
    *,
    ...
    async def identify(
        ...
        scoring_mode: Annotated[str | None, Query()] = None,
        reference_top_k: Annotated[int | None, Query(ge=1, le=32)] = None,
        reference_score_weight: Annotated[float | None, Query(ge=0.0, le=1.0)] = None,
    ):
