"""ONNX deployment boundary for semantic-v3 plus locked BIFOR fusion."""
...
class PreCroppedBIFORPetEmbeddingModel(nn.Module):
    """Frozen semantic-v3 and BIFOR encoders with the selected 8% projection.
    ...
    def __init__(
        ...
        if architecture.get("name") != "lowrank_semantic_body_fusion_v1":
            raise ValueError(
                "Expected lowrank_semantic_body_fusion_v1, got "
