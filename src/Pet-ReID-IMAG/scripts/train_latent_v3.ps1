...
if ($Microfit) {
    ...
    $legacyName = "modern_latent_v3_microfit_d192"
    $workstream = "latent-v3-microfit"
    $purpose = "microfit"
} elseif ($Smoke) {
    $configPath = "configs/modern_latent_v3_smoke.yaml"
    $legacyName = "modern_latent_v3_smoke_d192"
    $workstream = "latent-v3-smoke"
    $purpose = "smoke"
} else {
    $configPath = "configs/modern_latent_v3_s101_224.yaml"
    $legacyName = "modern_latent_v3_s101_224_d192"
    $workstream = "latent-v3"
    $purpose = "train"
}
