...
def test_v4_request_is_model_agnostic_and_does_not_leak_vectors_or_paths():
    request = AgentEvidenceRequest.from_identification(v4_identification())
...
def test_replay_fallback_can_call_the_stable_interface():
    result = decide_from_identification(v4_identification(), ReplayFallbackAgent())
