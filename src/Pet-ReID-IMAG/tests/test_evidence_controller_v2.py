...
from pet_id.evidence_controller_v2 import (
    OUTPUT_NAMES_V2,
...
def test_monotonic_bifor_and_unknown_logits():
    ...
    bifor = OUTPUT_NAMES_V2.index("bifor_correct")
    unknown = OUTPUT_NAMES_V2.index("unknown")
...
def test_v2_consult_then_accept_mega():
    probabilities = {
        "bifor_correct": 0.60,
        "mega_correct": 0.90,
        "unknown": 0.05,
