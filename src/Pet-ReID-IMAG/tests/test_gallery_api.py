...
class FakeEncoder:
    def __init__(self, fingerprint: str = "fake-model-v1"):
...
class GalleryAPITest(unittest.TestCase):
    def make_service(self, root: Path, fingerprint: str = "fake-model-v1"):
                ...
                json.dumps(
                    {
                        ...
                        "selected_backend": {"model_sha256": "fake-model-v1"},
