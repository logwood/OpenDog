...
DEFAULT_PROTOCOL_ROOT = historical_run_path(WORKSPACE, "joint-protocol")
DEFAULT_OUTPUT = historical_run_path(WORKSPACE, "agent-formal-evaluation")
...
def build_protocol(args: argparse.Namespace) -> dict[str, Any]:
    ...
    training_paths = [
        ...
        historical_run_path(WORKSPACE, "joint-rollback-protocol")
        / "train_manifest.json",
    ]
    ...
    exclusion_paths = [
        *training_paths,
        ...
        historical_run_path(WORKSPACE, "shared-fusion-baseline")
    ...
    protocol = {
        "schema_version": 1,
        "name": "agent_fixed_gallery_open_set",
        "created_at": utc_now(),
        "seed": args.seed,
        "policy": {
