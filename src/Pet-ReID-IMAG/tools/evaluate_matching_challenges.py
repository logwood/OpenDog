...
def main() -> None:
    ...
    parser.add_argument(
        "--manifest",
        type=Path,
        default=PROCESSED_DATA_ROOT / "local_pet_gallery_v1" / "dataset_manifest.json",
    )
    parser.add_argument(
        "--gallery-model",
        type=Path,
        default=SELECTED_MODELS_ROOT / "local_pet_gallery_joint800_onnx_v1" / "gallery_model.json",
    )
    parser.add_argument(
        "--config-file",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=EVALUATIONS_ROOT / "pet_matching_challenge_v1"
    )
    parser.add_argument(
        "--storage-dir",
        type=Path,
        default=GALLERY_STORE_ROOT / "pet_api_gallery_challenge_v1",
    )
