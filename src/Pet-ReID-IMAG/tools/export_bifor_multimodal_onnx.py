#!/usr/bin/env python3
"""Export and verify semantic-v3 + locked 8% BIFOR fusion as one ONNX graph."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--semantic-checkpoint",
        type=Path,
        default=WORKSPACE / "models/selected/dogfacenet_semantic_v3_v1/model_final.pth",
    )
    parser.add_argument(
        "--config-file",
        type=Path,
    ...
    parser.add_argument(
        "--fusion-checkpoint",
        type=Path,
        default=WORKSPACE / "artifacts/runs/bifor/lowrank_joint100_v1/model_final.pth",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=Path,
        default=WORKSPACE
        / "artifacts/runs/legacy/dogfacenet_body_swinv2b_joint100_validation_v1/body_semantic_features.npz",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=WORKSPACE
        / "models/selected/dogfacenet_semantic_v3_bifor_lowrank_v1/onnx",
    )
    parser.add_argument(
...
def main() -> None:
    ...
    metadata = {
        "schema_version": 2,
        "created_at": now,
        "model_type": "semantic_v3_bifor_lowrank_v1",
        ...
        "onnxruntime_version": ort.__version__,
        "opset": args.opset,
        "fusion_mode": "semantic_residual_v3+bifor_lowrank_v1",
        ...
        "gallery_compatibility": {
            "compatible_with_semantic_v3_v1": False,
    ...
    (output_dir / "README.md").write_text(
        ...
        "semantic-v3 nose/face and 8% frozen headless BIFOR body information. "
        ...
        "semantic-v3 galleries must be re-encoded before retrieval. The projector "
