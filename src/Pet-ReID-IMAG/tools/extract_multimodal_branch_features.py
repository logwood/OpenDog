#!/usr/bin/env python3
"""Cache frozen semantic nose/face features for body-fusion experiments."""
...
def main() -> None:
    ...
    if arrays["baseline_features"].shape[1] != 512:
        raise RuntimeError(
            "Expected the semantic public embedding to be 512-D, got "
    ...
    metadata = {
        "schema_version": 1,
        "purpose": "frozen_semantic_features_for_body_primary_fusion",
