...
def load_semantic_initialization(
    ...
    if not gate_state or not interaction_state:
        raise ValueError("Checkpoint is missing semantic gate/interaction tensors")
...
def main() -> None:
    ...
    with torch.inference_mode():
        ...
        compatibility = {
            "body_missing_mean_cosine_to_baseline": float(baseline_cosine.mean()),
            "body_missing_min_cosine_to_baseline": float(baseline_cosine.min()),
    ...
    def save_and_evaluate(step: int) -> None:
        ...
        checkpoint = {
            ...
            "architecture": {
                "name": "body_primary_semantic_residual",
    ...
    report = {
        ...
        "architecture": {
            ...
            "residual": "pretrained semantic bounded nose residual",
        ...
        "baseline_semantic_embedding": baseline_metrics,
