...
from pet_id.workspace_paths import RUNS_ROOT, normalize_runtime_config  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default=str(RUNS_ROOT / "manual" / "multimodal_dogfacenet_train"),
    )
    parser.add_argument(
        "--identity-weights",
        default="",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "encoders; encoder-only is the safe compatibility migration path"
        ),
    )
    parser.add_argument(
        "--joint-mix",
        ...
        torch.save(
            {
                ...
                "architecture": {
                    "name": (
                        ...
                        in {"shared_projection", "semantic_residual"}
                        else "residual_view_joint"
