...
def to_tensor(pic):
    ...
    # torchvision's public conversion API avoids the deprecated TypedStorage
    # constructor while preserving this project's original 0..255 scale.
    img = pil_to_tensor(pic)
    return img.float() if img.dtype == torch.uint8 else img
