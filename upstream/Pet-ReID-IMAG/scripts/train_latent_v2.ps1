...
if ($Microfit) {
    ...
    $outputPath = Join-Path $repoRoot "logs/modern_latent_v2_microfit_d192"
} elseif ($Smoke) {
    $configPath = "configs/modern_latent_v2_smoke.yaml"
    $outputPath = Join-Path $repoRoot "logs/modern_latent_v2_smoke_d192"
} else {
    $configPath = "configs/modern_latent_v2_s101_224.yaml"
    $outputPath = Join-Path $repoRoot "logs/modern_latent_v2_s101_224_d192"
}
