#!/usr/bin/env python3
"""Evaluate a 512-D low-rank projection of semantic-v3 and body features.
...
def main() -> None:
    ...
    torch.save(
        {
            ...
            "architecture": {
                ...
                "formula": (
                    "normalize(pad((concat(sqrt(1-w)*semantic_v3, "
    ...
    report = {
        ...
        "architecture": {
            "semantic_branch": "frozen semantic-v3 nose+face 512-D embedding",
